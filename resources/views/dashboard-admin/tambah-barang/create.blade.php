...
<body class="bg-gray-100">
    ...
    <div class="max-w-lg  ">
        ...
        <form action="{{ route('tambah-barang.uploud-barang')}}" method="POST" enctype="multipart/form-data" class="space-y-4">
            ...
            <div>
                <button type="submit" class="w-full bg-blue-500 text-white py-2 px-4 rounded-md shadow-md hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500">
                    Submit
                </button>
            </div>
        </form>
