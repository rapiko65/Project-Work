    ...
    <header class="header top-0 bg-white shadow-md flex items-center justify-between px-8 py-02 ">
        ...
        <div class="w-3/12 justify-end hidden md:flex">
            ...
            <!-- Search Input -->
            <div class="hidden absolute top-2 right-48 max-w-md mx-auto" id="searchMenu">
                <div class="relative flex items-center w-full h-12 shadow-xl rounded-lg focus-within:shadow-lg bg-white overflow-hidden">
            ...
            {{-- <div id="searchMenu" class="hidden absolute right-36 bg-white shadow-md rounded-md p-4 w-80">
                <input type="text"
                    placeholder="Search..."
            ...
            <div class="relative hidden md:block" x-data="{ dropdown: false }">
                ...
                <div x-show="dropdown" x-transition:enter="transition ease-out duration-100 transform" x-transition:enter-start="opacity-0 scale-95" x-transition:enter-end="opacity-100 scale-100" x-transition:leave="transition ease-in duration-75 transform" x-transition:leave-start="opacity-100 scale-100" x-transition:leave-end="opacity-0 scale-95" class="absolute right-0 mt-2 w-48 origin-top-right rounded-md z-50 bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="user-menu-button" tabindex="-1">
                    <!-- Active: "bg-gray-100", Not Active: "" -->
                    @if(Auth()->user()->role=="user")
                    ...
                    <a href="" class="block px-4 py-2 text-sm text-gray-700" role="menuitem" tabindex="-1" id="user-menu-item-0">Your Profile</a>
                    @endif
                    <a href="{{ route('logout-process') }}" onclick="event.preventDefault();document.getElementById('logout-form').submit();" class="block px-4 py-2 text-sm text-gray-700">Logout</a>
